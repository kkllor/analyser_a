...
public class Entrance {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            String operation = inputCheck(scanner, "input 'download' or 'analyse' ,'collect' ,'exit' for following operations ", "unknown operation", str -> str.equals("download") || str.equals("analyse") || str.equals("collect") || str.equals("exit"));
